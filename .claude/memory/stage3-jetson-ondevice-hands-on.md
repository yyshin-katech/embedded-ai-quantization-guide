...
PASS 🔴1·🟡3 전부 리뷰어 직접수정; 커밋 58ba518 푸시완료):** 위 후속3은 깨끗한 CNN(ResNet50)이었고 DETR은
...
HTML 재렌더. **tech-reviewer 팬인 PASS(🔴0·🟡1 fixed·🟢3)** — SSOT 1:1·raw npz 독립 재계산(baseline
0.4237/0.2383 정확 재현=무드리프트)·산술 13관계·SVG 비례·엔진 바이트 추적성 확인; 🟡=엔진크기 델타 단위 통일
(+0.19→+0.18 MiB 5곳). **커밋 b257a17 푸시완료.** 산출물 `logs/stage3_jetson_orin_detr_smoothquant_report.html`(§1~6·SVG 2종: gap 회복률 factor 5.5px/%
