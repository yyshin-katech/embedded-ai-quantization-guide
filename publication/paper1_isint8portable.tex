\pdfoutput=1  % arXiv: select pdflatex. Must stay within the first 5 lines.
% NOTE: compile with pdfLaTeX, not LuaLaTeX (the line above is undefined under LuaTeX).
% =====================================================================
...
%  arXiv:  upload paper1_isint8portable.tex together with the generated
%          .bbl -- arXiv runs pdflatex but does NOT run bibtex.
%
%  Empirical sections are wired from the repository SSOT
%  (32 reports in logs/, 9 suites in experiments/).
...
%
%  Artifact: https://github.com/yyshin-katech/embedded-ai-quantization-guide/tree/paper1-v1
% =====================================================================
