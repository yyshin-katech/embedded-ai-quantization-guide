...
\paragraph{Artifact availability.} Measurement scripts and 32 HTML reports are released with this paper; Appendix~\ref{app:map} maps every numbered claim to the report and script that produced it. \texttt{[link TBD]}
