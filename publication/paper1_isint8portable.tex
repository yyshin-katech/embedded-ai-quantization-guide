...
%  repository SSOT (31 reports in logs/, 9 suites in experiments/).
...
\item A reproducibility artifact: scripts plus 31 measurement reports, and a claim-to-artifact map (Appendix~\ref{app:map}).
\end{itemize}
...
\paragraph{Artifact availability.} Measurement scripts and 31 HTML reports are released with this paper; Appendix~\ref{app:map} maps every numbered claim to the report and script that produced it. \texttt{[link TBD]}
