...
이 저장소에 축적된 실측 코퍼스(`logs/` 31건 · `experiments/` 9군)를 학술 논문으로 정리하기 위한 작업 폴더.
...
- **최대 약점:** 통계적 엄밀성(batch1·단일실행·서브셋·지연 CI 부재). *관련연구 미작성*은 **2026-09-04 해소** — §2 Related Work 작성 + BibTeX 46건 전량 웹 실검증 완료.
